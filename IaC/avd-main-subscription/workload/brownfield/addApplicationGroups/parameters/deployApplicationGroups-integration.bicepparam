...
param workspaceResourceId = '/subscriptions/bf71c834-f4b7-4e3e-b221-d4052b2aabe6/resourcegroups/rg-avd-epcint-tst-euw-008/providers/Microsoft.DesktopVirtualization/workspaces/avd-tst-epcint-euw-ws'
param workspaceFriendlyName = 'Tuotanto-Koulutus-Ekosysteemi'
param managementPlaneLocation = 'westeurope'
param serviceObjectsRgName = 'rg-avd-epcint-tst-euw-008'
