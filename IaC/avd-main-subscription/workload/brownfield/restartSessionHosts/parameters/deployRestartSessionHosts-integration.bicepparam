using '../deploy.bicep'
param automationAccountName = 'aa-avd-tst-euw-003'
param runbookName  = 'runbk-avd-int-euw-003'
...
param hostPoolResourceGroup = 'rg-avd-epcint-tst-euw-008'
param hostPoolName = 'avd-tst-epcint-euw-hostpool'
param sessionHostResourceGroup  = 'rg-avd-epcint-tst-sec-0010'
